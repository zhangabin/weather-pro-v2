 ...
 * @FilePath: \isio-member-ui\src\layout\components\bigScreen\singleArea.vue
-->
<template>
  <div class="js-con">
    ...
    <!-- 柱状图 -->
    <div class="js-chart" ref="singleAreaChart">
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      //   document.getElementById('roadnum').style.width = this.$refs.singleAreaChart.offsetWidth + 'px';
      //   document.getElementById('roadnum').style.height = this.$refs.singleAreaChart.offsetHeight + 'px';
      //   this.draw();
      // })
    },
    watch: {
    ...
    methods: {
      ...
      draw() {
        // 网络请求 假装从后端拿回来的数据
        this.data = [
          { name: '2020-08-29', value: 10 },
          { name: '2020-08-29', value: 20 },
          { name: '2020-08-29', value: 30 },
          { name: '2020-08-29', value: 40 },
          { name: '2020-08-29', value: 50 },
          { name: '2020-08-29', value: 60 },
          { name: '2020-08-29', value: 70 },
          { name: '2020-08-29', value: 80 },
          { name: '2020-08-29', value: 90 }
        ];
        // 拼轴显示和数据的数组
        let xAxisText = [];
        let dataList = [];
